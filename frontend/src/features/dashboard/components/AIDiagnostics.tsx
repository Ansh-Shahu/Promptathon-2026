...
import Card3D from '../../../shared/components/Card3D'
                  ...
                  <div key={t.id} className="rounded-lg p-3 flex items-start gap-3" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className={`text-[9px] font-semibold uppercase px-1.5 py-0.5 rounded-full ${t.status === 'resolved' ? 'bg-status-ok/10 text-status-ok' :
